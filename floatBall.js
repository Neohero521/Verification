...
export const FloatBall = {
    ...
    init() {
        ...
        if (!this.ball || !this.panel) {
            ...
            toastr.error("小说续写插件加载失败：UI元素缺失", "插件错误");
            return;
        }
    ...
    onDrag(e) {
        ...
        extension_settings.Always_remember_me.floatBallState.position = { x, y };
    ...
    autoAdsorbEdge() {
        ...
        extension_settings.Always_remember_me.floatBallState.position = { x: newRect.left, y: newRect.top };
        saveSettingsDebounced();
    },
    ...
    showPanel() {
        ...
        extension_settings.Always_remember_me.floatBallState.isPanelOpen = true;
        saveSettingsDebounced();
    },

    hidePanel() {
        this.panel.classList.remove("show");
        extension_settings.Always_remember_me.floatBallState.isPanelOpen = false;
        saveSettingsDebounced();
    },
    ...
    switchTab(tabId) {
        ...
        extension_settings.Always_remember_me.floatBallState.activeTab = tabId;
        saveSettingsDebounced();
    },
