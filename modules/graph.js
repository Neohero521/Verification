import { extensionName, graphJsonSchema, mergeGraphJsonSchema } from "./constants.js";
import { state } from "./state.js";
import { setButtonDisabled, updateProgress, removeBOM } from "./utils.js";
import { getActivePresetParams } from "./preset.js";
import { renderChapterList } from "./chapter.js";
...
export async function updateModifiedChapterGraph(chapterId, modifiedContent) {
    ...
    try {
        ...
        const result = await generateRaw({ systemPrompt, prompt: userPrompt, jsonSchema: graphJsonSchema, ...getActivePresetParams()});
        const graphData = JSON.parse(result.trim());
        const graphMap = extension_settings[extensionName].chapterGraphMap || {};
