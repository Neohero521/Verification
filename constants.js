...
export let isGeneratingGraph = false;
export let isGeneratingWrite = false;
export let stopGenerateFlag = false;
export let isSending = false;
export let stopSending = false;
export let continueWriteChain = [];
export let continueChapterIdCounter = 1;
export let currentPrecheckResult = null;
export let isInitialized = false;

// 图谱JSON Schema（完全保留原有定义）
...
// 导出ST核心API，供其他模块统一使用
export { extension_settings, getContext, loadExtensionSettings, saveSettingsDebounced };
